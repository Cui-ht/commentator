...
export function BackIcon({ className = 'w-5 h-5 text-gray-600' }: IconProps) {
  return (
...
export function CheckIcon({ className = 'w-6 h-6 text-green-600' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
